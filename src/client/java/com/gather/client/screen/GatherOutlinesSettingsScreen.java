...
public class GatherOutlinesSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new AbstractSliderButton(cx - 100, cy - 30, 200, 20,
                Component.literal("Outline Range: " + radiusLabel(GatherSettings.get().highlightRadius)),
            ...
            @Override protected void updateMessage() { setMessage(Component.literal("Outline Range: " + radiusLabel(toRadius()))); }
    ...
    private void drawHoverInfo(int mx, int my) {
        ...
        if (inside(mx, my, cx - 100, cy - 55, 200, 20)) {
            ...
            setTooltip(mx, my,
                    Component.literal("Horizontal scan distance in chunks."),
                    Component.literal("Only loaded chunks can be scanned."),
